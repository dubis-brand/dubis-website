...
const products = [
...

    {
        ...
        description_he: "חולצה שנועדה לאנשים שנהנים מהחיים, אוהבים אוכל טוב, ולא חייבים הסברים לאף אחד.",
    ...
    },
    {
        ...
        description_he: "הקפוצ'ון למי שהבין שהחיים קצרים מדי בשביל לרוץ על הליכון, ומספיק ארוכים בשביל שנ\"צ טוב.",
    ...
    },
    {
        ...
        description_he: "התשובה הניצחת לכל תא מדידה שאי פעם גרם לך להרגיש פגום. גזרה מחמיאה שלא דורשת ממך להיות שום דבר חוץ ממי שאתה.",
        fabric: "80% cotton, 20% polyester — heavyweight fleece",
        fit: "Unisex, relaxed fit",
        printMethod: "DTG — Direct-to-Garment",
        printAreas: ["Front", "Back"],
