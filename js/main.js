...
const translations = {
  en: {
    ...
    modal_made: '🏭 Made fresh via Printful',
    modal_material: '👕 Premium materials',
    modal_returns: '↩️ Easy returns',
  ...
  he: {
    ...
    modal_made: '🏭 מיוצר טרי דרך Printful',
    modal_material: '👕 חומרים איכותיים',
    modal_returns: '↩️ החזרה קלה',
    modal_add: 'הוסף לסל 🐾',
