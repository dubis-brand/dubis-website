...
const TEMPLATES: Record<string, Template> = {
  ...
  // (off brand:null Hila-K risk). Only the mens cut exists; gqa=classic, gpr=4-4.
...
const COLOR_MAP: Record<string, Record<string, ColorEntry>> = {
  ...
  // 2026-06-13: Gildan v-neck 64v00 / tank 5200 color slugs (verified live).
  // Slugs differ per SKU — v-neck red="cherry-red"/gray="rs-sport-grey",
  // tank red="red"/gray="sport-grey". Do not share slugs across the two.
  'vneck-unisex': {
    'Black': 'black', 'White': 'white', 'Navy': 'navy', 'Charcoal': 'charcoal',
    'Red': 'cherry-red', 'Gray': 'rs-sport-grey', 'Royal Blue': 'royal-blue',
  },
  'vneck-women': {
  ...
  'tanktop-unisex': {
    ...
    'Forest Green': 'forest-green', 'Gray': 'sport-grey', 'Royal Blue': 'royal',
  },
  'tanktop-women': {
    'Black': 'black',
  },
